...
symbols_1 <- as.character(read.csv2("TTS_vs_AP_DEG_UP.csv")[,1])
...
# 19. Plot Supplementary Figure 5A, Left
```{r packages, message=FALSE, warning=FALSE}
...
symbols_2 <- as.character(read.csv2("TTS_vs_AP_DEG_DOWN.csv")[,1])
...
# 20. Plot Supplementary Figure 5A, Right
```{r packages, message=FALSE, warning=FALSE}
